...
## Optional OpenAI Server AI

The iPhone app should not store an OpenAI API key directly. Instead, run this project server with the key on your Mac or a deployed host:
...
In the iPhone app, go to Account -> AI Server and enter your server URL. For a real iPhone on the same Wi-Fi as your Mac, use your Mac's local IP address, for example:

```text
http://192.168.1.25:5173
```

The app still keeps fast launch-day predictions local and offline. The server is used for heavier parsing and future recommendation work.
